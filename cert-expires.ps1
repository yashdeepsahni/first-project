...
# Automatic file path for export
$ExportPath = "$HOME/Application_Secrets_Report.csv"
$Logs | Export-Csv $ExportPath -NoTypeInformation -Encoding UTF8

Write-Host "File automatically saved to $ExportPath" -ForegroundColor Green
